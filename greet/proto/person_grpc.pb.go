...
type PersonServiceClient interface {
	GetPersonByID(ctx context.Context, in *GetPersonByIDRequest, opts ...grpc.CallOption) (*PersonResponse, error)
}
...
func (c *personServiceClient) GetPersonByID(ctx context.Context, in *GetPersonByIDRequest, opts ...grpc.CallOption) (*PersonResponse, error) {
	out := new(PersonResponse)
	err := c.cc.Invoke(ctx, "/person.PersonService/GetPersonByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PersonServiceServer interface {
	GetPersonByID(context.Context, *GetPersonByIDRequest) (*PersonResponse, error)
...
func (UnimplementedPersonServiceServer) GetPersonByID(context.Context, *GetPersonByIDRequest) (*PersonResponse, error) {
...
func _PersonService_GetPersonByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/person.PersonService/GetPersonByID",
	}
